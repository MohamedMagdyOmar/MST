...
class SukunTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.chars_count = WordLetterProcessingHelperMethod.get_chars_count_for_each_word_in_this(self.sukun_words)
        self.Chars = WordLetterProcessingHelperMethod.convert_list_of_words_to_list_of_chars(self.sukun_words)
    ...
    def test_feature_one(self):
        ...
        self.write_data_into_excel_file(self.Chars_After_Sukun, self.Chars)
